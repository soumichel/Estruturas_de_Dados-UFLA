 ...
 *                       
    ...
    Enunciado 3 - Redimensionar o vetor adicionando três novas posições a cada redimensionamento
*/
...
class portfolio {
    ...
    public:
        ...
        portfolio(const portfolio& copia);  //construtor de cópia
        ~portfolio();
...
portfolio::portfolio(const portfolio& copia) {  //construtor de cópia
    quantidadeDeProdutos = copia.quantidadeDeProdutos;
    capacidadeMaxima = copia.capacidadeMaxima;
    listaDeProdutos = new produto[capacidadeMaxima];
    copy(copia.listaDeProdutos, copia.listaDeProdutos + copia.quantidadeDeProdutos, listaDeProdutos);
}
...
void portfolio::redimensionarCapacidade() {
    int novaCapacidade = capacidadeMaxima + (capacidadeMaxima * 0.5);
    produto *listaAux = new produto[novaCapacidade];
    copy(listaDeProdutos, listaDeProdutos + quantidadeDeProdutos, listaAux);
    delete[] listaDeProdutos;
    
    capacidadeMaxima = capacidadeMaxima + (capacidadeMaxima * 0.5);
    
    listaDeProdutos = new produto[capacidadeMaxima];
    copy(listaAux, listaAux + quantidadeDeProdutos, listaDeProdutos);
    delete[] listaAux;
}
